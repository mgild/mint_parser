...
impl RpcArgs {
    ...
    pub fn estimate_transaction_fee(
        ...
        let x =
            match bincode::options().deserialize::<ComputeBudgetInstruction>(&tx.message.instructions[0].data[..])
                .unwrap_or(ComputeBudgetInstruction::SetComputeUnitLimit(0))
            {
        ...
        let y =
            match bincode::options().deserialize::<ComputeBudgetInstruction>(&tx.message.instructions[1].data[..])
                .unwrap_or(ComputeBudgetInstruction::SetComputeUnitLimit(0))
            {
                ComputeBudgetInstruction::SetComputeUnitPrice(price) => price,
                ComputeBudgetInstruction::SetComputeUnitLimit(compute_unit) => compute_unit as u64,
    ...
    pub fn estimate_versioned_transaction_fee(
        ...
        let x = match bincode::options().deserialize::<ComputeBudgetInstruction>(&instructions[1].data[..])
            .unwrap_or(ComputeBudgetInstruction::SetComputeUnitLimit(0))
        {
            ComputeBudgetInstruction::SetComputeUnitPrice(price) => price,
            ComputeBudgetInstruction::SetComputeUnitLimit(compute_unit) => compute_unit as u64,
        ...
        let y = match bincode::options().deserialize::<ComputeBudgetInstruction>(&instructions[0].data[..])
            .unwrap_or(ComputeBudgetInstruction::SetComputeUnitLimit(0))
        {
            ComputeBudgetInstruction::SetComputeUnitPrice(price) => price,
            ComputeBudgetInstruction::SetComputeUnitLimit(compute_unit) => compute_unit as u64,
